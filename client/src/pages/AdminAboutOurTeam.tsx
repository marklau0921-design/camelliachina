  ...
  return (
    <AdminLayout title="Our Team">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
        <div>
          <a href="/admin/about" style={{ fontSize: '12px', color: '#999', textDecoration: 'none', letterSpacing: '0.08em', textTransform: 'uppercase', display: 'inline-flex', alignItems: 'center', gap: '4px', marginBottom: '8px' }}>← Back to About</a>
          <h1 style={{ margin: 0, fontFamily: 'Georgia, serif', fontWeight: 400 }}>Our Team</h1>
