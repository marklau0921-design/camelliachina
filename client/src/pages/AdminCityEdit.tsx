...
export default function AdminCityEdit() {
  ...
  useEffect(() => {
    if (city && !initialized) {
      setInitialized(true);
      const legacySections = legacyCulinaryTravelSections(city);
      setForm({
        name: city.name || "",
        slug: city.slug || "",
        ...
        culinaryTravelTitle: (city as any).culinaryTravelTitle || "Culinary Travel",
        culinaryTravelSections: JSON.stringify(parseCulinaryTravelSections((city as any).culinaryTravelSections, legacySections)),
